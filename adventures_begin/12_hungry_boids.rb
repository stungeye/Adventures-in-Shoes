...
class Boid
  ...
  def calculate_new_velocity boids, foodstuff
    calculate_avoidance_delta boids   # Avoid other boids
    calculate_attraction_delta boids  # Gravitate towards the centre-of-mass of nearby boids
    calculate_alignment_delta boids   # Align velocity with nearby boids
    calculate_hunting_delta foodstuff # Be on the lookout for food
    calculate_stay_visible_delta      # Don't fly too far from home
...
Shoes.app(:title => "Hungry Boids v0.6", :height => 600, :width => 800) do
  ...
  animate(24) do
    clear do
      boids.each do |boid|
        boid.calculate_new_velocity boids, foodstuff
        boid.move
        boid.draw
